    ...
    public class CharacterStub : ICharacter
    {
        ...
        public CharacterStub()
        {
            this.Characterlist = new List<CharacterDTO>()
            {
                ...
                new CharacterDTO{ID = 2, user_id = 2, name = "Bobby", str = 5, dex = 5, con = 5, intt = 5, wis = 5, cha = 5, level = 3, speed = 30, char_class = new ClassDTO(){ID = 1, name = "barb" }, char_race = new RaceDTO(){ID = 1, name = "elf" } },
                ...
                new CharacterDTO{ID = 4, user_id = 1, name = "bert", str = 7, dex = 7, con = 7, intt = 7, wis = 7, cha = 7, level = 1, speed = 30, char_class = new ClassDTO(){ID = 1, name = "barb" }, char_race = new RaceDTO(){ID = 1, name = "elf" } }
            };
        }
